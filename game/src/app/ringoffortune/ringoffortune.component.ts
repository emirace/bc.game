...
export class RingoffortuneComponent implements OnInit {
  ...
  currency: any = 'JBC';
  disable: any = true;
  autodisable: any = true;
  toggleone = false;
  //manual bet
  bet_amount: any;
  totalbets: any = (0).toFixed(6);
  payResult: any = 0;
  bet_amount1: any = (0).toFixed(6);
  bet_amount2: any = (0).toFixed(6);
  bet_amount3: any = (0).toFixed(6);
  bet_amount4: any = (0).toFixed(6);
  min_bet = 100;
  max_bet = 10000000;
  //auto
  auto_bet_amount: any;
  auto_bet_amount1: any = (0).toFixed(6);
  auto_bet_amount2: any = (0).toFixed(6);
  auto_bet_amount3: any = (0).toFixed(6);
  auto_bet_amount4: any = (0).toFixed(6);
  numberofbets: any = 0;
  stop_on_win: any = 0;
  stop_on_loss: any = 0;
  auto_bet: any = true;
  stop_init: any = 1;
  disabledHead: any = false;
  ...
  constructor(
    ...
    this.httpService
      .postRequest('basic/Specificgame', { name: 'fortune' }, this.token)
  ...
  ngOnInit(): void {
    ...
    this.getgraph();
    this.chart = Highcharts.chart('containerX', this.chartOptions2);
  ...
  allUser_history() {
    this.httpService
      .postRequest('fortune/getAllBetHistory', {}, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  bettingamount(type: any, value: any, color: any) {
    ...
    if (this.bet_amount == 0) {
      this.bet_amount = 0;
    } else if (this.bet_amount < this.min_bet) {
      this.bet_amount = (this.min_bet * 1).toFixed(6);
    }
    ...
    if (color == 'grey') {
      ...
      if (this.bet_amount1 >= 100) {
        this.disable = false;
      }
    } else if (color == 'purple') {
      this.bet_amount2 = (this.bet_amount * 1).toFixed(6);
      if (this.bet_amount2 >= 100) {
        this.disable = false;
      }
    } else if (color == 'orange') {
      this.bet_amount3 = (this.bet_amount * 1).toFixed(6);
      if (this.bet_amount3 >= 100) {
        this.disable = false;
      }
    } else if (color == 'green') {
      this.bet_amount4 = (this.bet_amount * 1).toFixed(6);
      if (this.bet_amount4 >= 100) {
        this.disable = false;
      }
    }
    this.totalbets =
      Number(this.bet_amount1) +
      Number(this.bet_amount2) +
      Number(this.bet_amount3) +
      Number(this.bet_amount4);
  }
  ...
  auto_bettingamount(type: any, value: any, color: any) {
    ...
    if (color == 'grey') {
      ...
      if (this.auto_bet_amount1 >= 100) {
        this.autodisable = false;
      }
    } else if (color == 'purple') {
      this.auto_bet_amount2 = (this.auto_bet_amount * 1).toFixed(6);
      if (this.auto_bet_amount2 >= 100) {
        this.autodisable = false;
      }
    } else if (color == 'orange') {
      this.auto_bet_amount3 = (this.auto_bet_amount * 1).toFixed(6);
      if (this.auto_bet_amount3 >= 100) {
        this.autodisable = false;
      }
    } else if (color == 'green') {
      this.auto_bet_amount4 = (this.auto_bet_amount * 1).toFixed(6);
      if (this.auto_bet_amount4 >= 100) {
        this.autodisable = false;
      }
    }
    this.totalbets =
      Number(this.auto_bet_amount1) +
      Number(this.auto_bet_amount2) +
      Number(this.auto_bet_amount3) +
      Number(this.auto_bet_amount4);
  }

  reset(data: any) {
    if (data == 'auto') {
      this.auto_bet_amount1 = (0).toFixed(6);
      this.auto_bet_amount2 = (0).toFixed(6);
      this.auto_bet_amount3 = (0).toFixed(6);
      this.auto_bet_amount4 = (0).toFixed(6);
      this.autodisable = true;
    } else {
      this.bet_amount1 = (0).toFixed(6);
      this.bet_amount2 = (0).toFixed(6);
      this.bet_amount3 = (0).toFixed(6);
      this.bet_amount4 = (0).toFixed(6);
      this.disable = true;
    }
  ...
  submitBet() {
    if (this.head != false) {
      this.toggleone = true;
      var color: any = [];
      if (this.bet_amount1 != 0) {
        color.push({ color: '#cfdff7', amount: this.bet_amount1 });
      } else {
        color.push({ color: '#cfdff7', amount: 0 });
      }

      if (this.bet_amount2 != 0) {
        color.push({ color: '#773cfd', amount: this.bet_amount2 });
      } else {
        color.push({ color: '#773cfd', amount: 0 });
      }

      if (this.bet_amount3 != 0) {
        color.push({ color: '#ff842e', amount: this.bet_amount3 });
      } else {
        color.push({ color: '#ff842e', amount: 0 });
      }

      if (this.bet_amount4 != 0) {
        color.push({ color: '#7bc514', amount: this.bet_amount4 });
      } else {
        color.push({ color: '#7bc514', amount: 0 });
      }

      if (this.totalbets <= this.balance) {
        var data = {
          bet_amount: parseInt(this.bet_amount, 10).toString(),
          currency: this.currency,
        };
    ...
    try {
      ...
      if (results.success == 1) {
        ...
        var datas = {
          bet_amount: value,
          currency: this.currency,
          clientSeed: results.clientSeed,
          serverSeed: results.serverSeed,
          nonce: results.nonce,
          result: integerPart,
          pay_out: this.pay_out.val,
          game_result: this.payResult,
        };
        var resData1: any = await this.httpService.postRequestUpdated(
          'fortune/saveBetHistory',
          datas,
          this.token
        );
      ...
      if (this.head != false) {
        ...
        if (!this.isSpinning && this.auto_bet != true) {
          ...
          for (var j = 0; j <= this.numberofbets; j++) {
            ...
            if (this.totalbets <= this.balance) {
              var data = {
                bet_amount: parseInt(this.auto_bet_amount, 10).toString(),
                currency: this.currency,
              };
              if (
  ...
  getDetails(id: any) {
    ...
    this.httpService
      .postRequest('fortune/getDetails', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  Seedsetting() {
    this.httpService
      .postRequest('fortune/getHash', {}, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  generateSeed() {
    ...
    this.httpService
      .postRequest('fortune/generateHash', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  updateHash() {
    ...
    this.httpService
      .postRequest('fortune/changeHash', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  userFav(name: any) {
    var obj = { name: name };
    this.httpService
      .postRequest('fortune/userFav', obj, this.token)
      .subscribe((resData: any) => {
  ...
  userLike(name: any) {
    var obj = { name: name };
    this.httpService
      .postRequest('fortune/userLiked', obj, this.token)
      .subscribe((resData: any) => {
