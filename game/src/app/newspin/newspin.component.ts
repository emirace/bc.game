...
@Component({
  ...
  animations: [
    trigger('flipState', [
      ...
      state('1', style({ transform: 'rotate(466.8deg)' })),
      state('2', style({ transform: 'rotate(542deg)' })),
      state('3', style({ transform: 'rotate(437deg)' })),
      state('5', style({ transform: 'rotate(482deg)' })),
      state('20', style({ transform: 'rotate(496.5deg)' })),
      state('30', style({ transform: 'rotate(557deg)' })),
      state('50', style({ transform: 'rotate(527deg)' })),
      state('100', style({ transform: 'rotate(572deg)' })),
...
export class NewspinComponent implements OnInit {
  ...
  constructor(
    ...
    this.httpService
      .postRequest('basic/Specificgame', { name: 'sword' }, this.token)
  ...
  async submitBet() {
    ...
    if (auth == true) {
      ...
      jQuery('.idcls').removeClass('loss');
      jQuery('.idcls').removeClass('win');
      ...
      const interval = setInterval(() => {
        ...
        if (randomTop2 == 17 || randomTop2 == 18) {
          randomTop2 = 16;
        }
        if (randomTop3 == 16 || randomTop3 == 18) {
          randomTop3 = 17;
        }
        if (randomTop4 == 16 || randomTop4 == 17) {
          randomTop4 = 18;
        }
        if (randomBottom2 == 17 || randomBottom2 == 18) {
          randomBottom2 = 16;
        }
        if (randomBottom3 == 16 || randomBottom3 == 18) {
          randomBottom3 = 17;
        }
        if (randomBottom4 == 16 || randomBottom4 == 17) {
          randomBottom4 = 18;
        }
        ...
        if (randomIndex2 == 17 || randomIndex2 == 18) {
          randomIndex2 = 16;
        }
        if (randomIndex3 == 16 || randomIndex3 == 18) {
          randomIndex3 = 17;
        }
        if (randomIndex4 == 16 || randomIndex4 == 17) {
          randomIndex4 = 18;
        }
      ...
      if (Buttom2 == 17 || Buttom2 == 18) {
        Buttom2 = 16;
      }
      if (Buttom3 == 16 || Buttom3 == 18) {
        Buttom3 = 17;
      }
      if (Buttom4 == 16 || Buttom4 == 17) {
        Buttom4 = 18;
      }
      ...
      this.httpService
        .postRequest('sword/getGameResult', data, this.token)
        .subscribe(async (resData: any) => {
          ...
          if (resData.success == 1) {
            ...
            if (gameres[1] == 17 || gameres[1] == 18) {
              gameres[1] = 16;
            }
            if (gameres[2] == 16 || gameres[2] == 18) {
              gameres[2] = 17;
            }
            if (gameres[3] == 16 || gameres[3] == 17) {
              gameres[3] = 18;
            }
            if (gameres[1] == 16) {
              jQuery('#wincol2').addClass('sword');
            }
            if (gameres[2] == 17) {
              jQuery('#wincol3').addClass('sword');
            }
            if (gameres[3] == 18) {
              jQuery('#wincol4').addClass('sword');
            }
            ...
            if (catspinval[0] !== null) {
              this.catspinbet(2, catspinval[0]);
              jQuery('#catspin1').addClass('catroll');
            }
            if (catspinval[1] !== null) {
              this.catspinbet(3, catspinval[1]);
              jQuery('#catspin2').addClass('catroll');
            }
            if (catspinval[2] !== null) {
              this.catspinbet(4, catspinval[2]);
              jQuery('#catspin3').addClass('catroll');
            }
            //sword spin
  ...
  async makeHttpPostRequest(counter: any, positions: any) {
    ...
    this.httpService
      .postRequest('sword/bonusSpin', obj, this.token)
      .subscribe(async (resData: any) => {
        if (resData.success == 1) {
          jQuery('.winsword').removeClass('sword');
          ...
          const positions = resData.msg.reduce(
  ...
  async catspinbet(num: any, val: any) {
    const interval = setInterval(() => {
      ...
      if (num == 2 && (spinran == 12 || spinran == 13)) {
        spinran = 11;
      }
      if (num == 3 && (spinran == 11 || spinran == 13)) {
        spinran = 12;
      }
      if (num == 4 && (spinran == 11 || spinran == 12)) {
        spinran = 13;
      }
      if (num == 2 && (spinran1 == 12 || spinran1 == 13)) {
        spinran1 = 11;
      }
      if (num == 3 && (spinran1 == 11 || spinran1 == 13)) {
        spinran1 = 12;
      }
      if (num == 4 && (spinran1 == 11 || spinran1 == 12)) {
        spinran1 = 13;
      }
      if (num == 2 && (spinran2 == 12 || spinran2 == 13)) {
        spinran2 = 11;
      }
      if (num == 3 && (spinran2 == 11 || spinran2 == 13)) {
        spinran2 = 12;
      }
      if (num == 4 && (spinran2 == 11 || spinran2 == 12)) {
        spinran2 = 13;
      }
    ...
    if (num == 2 && (ramspinval1 == 12 || ramspinval1 == 13)) {
      ramspinval1 = 11;
    }
    if (num == 3 && (ramspinval1 == 11 || ramspinval1 == 13)) {
      ramspinval1 = 12;
    }
    if (num == 4 && (ramspinval1 == 11 || ramspinval1 == 12)) {
      ramspinval1 = 13;
    }
    if (num == 2 && (ramspinval2 == 12 || ramspinval2 == 13)) {
      ramspinval2 = 11;
    }
    if (num == 3 && (ramspinval2 == 11 || ramspinval2 == 13)) {
      ramspinval2 = 12;
    }
    if (num == 4 && (ramspinval2 == 11 || ramspinval2 == 12)) {
      ramspinval2 = 13;
    }
    ...
    if (num == 2 && (ramspinval == 12 || ramspinval == 13)) {
      ramspinval = 11;
    }
    if (num == 3 && (ramspinval == 11 || ramspinval == 13)) {
      ramspinval = 12;
    }
    if (num == 4 && (ramspinval == 11 || ramspinval == 12)) {
      ramspinval = 13;
    }
    if (num == 2) {
  ...
  allUser_history() {
    this.httpService
      .postRequest('sword/getAllBetHistory', {}, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  getDetails(id: any) {
    ...
    this.httpService
      .postRequest('sword/getDetails', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  Seedsetting() {
    this.httpService
      .postRequest('sword/getHash', {}, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  generateSeed() {
    ...
    this.httpService
      .postRequest('sword/generateHash', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  updateHash() {
    ...
    this.httpService
      .postRequest('sword/changeHash', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  userFav(name: any) {
    var obj = { name: name };
    this.httpService
      .postRequest('sword/userFav', obj, this.token)
      .subscribe((resData: any) => {
  ...
  userLike(name: any) {
    var obj = { name: name };
    this.httpService
      .postRequest('sword/userLiked', obj, this.token)
      .subscribe((resData: any) => {
