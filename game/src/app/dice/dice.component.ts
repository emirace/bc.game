...
export class DiceComponent implements OnInit {
  ...
  constructor(
    ...
    this.httpService
      .postRequest('basic/Specificgame', { name: 'dice' }, this.token)
  ...
  full_history() {
    this.httpService
      .postRequest('dice/getAllBetHistory', {}, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  Seedsetting() {
    this.httpService
      .postRequest('dice/getHash', {}, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  showMoreBet() {
    this.httpService
      .postRequest('dice/getAllBetHis', {}, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  updateHash() {
    ...
    this.httpService
      .postRequest('dice/changeHash', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  generateSeed() {
    ...
    this.httpService
      .postRequest('dice/generateHash', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  Details(id: any) {
    ...
    this.httpService
      .postRequest('dice/getDetails', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  userFav(name: any) {
    var obj = { name: name };
    this.httpService
      .postRequest('dice/userFav', obj, this.token)
      .subscribe((resData: any) => {
  ...
  userLike(name: any) {
    var obj = { name: name };
    this.httpService
      .postRequest('dice/userLiked', obj, this.token)
      .subscribe((resData: any) => {
