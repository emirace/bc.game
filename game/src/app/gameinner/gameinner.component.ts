...
export class GameinnerComponent implements OnInit {
  ...
  constructor(
    ...
    this.httpService
      .postRequest('basic/Specificgame', { name: 'limbo' }, this.token)
  ...
  showMoreBet() {
    this.httpService
      .postRequest('limbo/getAllBetHis', {}, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  updateHash() {
    ...
    this.httpService
      .postRequest('limbo/changeHash', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  generateSeed() {
    ...
    this.httpService
      .postRequest('limbo/generateHash', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  Seedsetting() {
    this.httpService
      .postRequest('limbo/getHash', {}, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
  ...
  userFav(name: any) {
    var obj = { name: name };
    this.httpService
      .postRequest('limbo/userFav', obj, this.token)
      .subscribe((resData: any) => {
  ...
  userLike(name: any) {
    var obj = { name: name };
    this.httpService
      .postRequest('limbo/userLiked', obj, this.token)
      .subscribe((resData: any) => {
  ...
  Details(id: any) {
    ...
    this.httpService
      .postRequest('limbo/getDetails', obj, this.token)
      .subscribe((resData: any) => {
        if (resData.success == 1) {
